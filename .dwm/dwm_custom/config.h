...
static const char *dmenucmd[] 		= { "dmenu_run", "-b", "-i", "-p", "Search", "-fn",
                                        "Noto Sans:size=8", "-w", "360", "-h", "20", "-x",
                                        "24", "-y", "48", "-dim", "0.4", "-sf", "#000000",
                                        "-sb", "#8b97b1", "-nb", "#000000", "-nf", "#8b97b1",  NULL };

static const char *termcmd[] 		= { "st", NULL, };
static const char *rubycmd[] 		= { "st", "-n", "Ruby", "-geometry", "122x55", "-e", "irb", NULL, };
static const char *lockscreen[]     = { "i3lock-fancy-dualmonitor", NULL };
static const char *lfmcmd[] 		= { "st", "-n", "Total Commander", "-geometry", "95x45", "-e", "ranger", NULL, };
